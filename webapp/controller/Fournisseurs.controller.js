      ...
      return Controller.extend("commandearticle.controller.Fournisseurs", {
        ...
        onInit: function () {
            ...
            oSmartTableFilter.attachSearch(function () {
                ...
                // var oFilter = new Filter("Fournisseur", FilterOperator.EQ, sVendorsId); >>>>>>>>>>>>>>>>>>
                ...
                that.getOwnerComponent().getModel().read(`/FournissSet`, {
                    ...
                    success: function (data) {
                        ...
                        if (data.results) {
                            ...
                            oRadialMicroChart.setFraction(that._onGetPercentage(oData, 'Pays', 'MA'));
                            ...
                            // Calculate and set values to the view
                            oRadialMicroChart.setFraction(that._onGetPercentage(oData, 'Language', 'FR'));
                            ...
                            // Calculate and set values to the view
                            oRadialMicroChart.setFraction(that._onGetPercentage(oData, 'NaturePerso', 'X'));
